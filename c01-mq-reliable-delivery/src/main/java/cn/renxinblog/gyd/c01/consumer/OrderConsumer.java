package cn.renxinblog.gyd.c01.consumer;
...
public class OrderConsumer {
    ...
    public OrderConsumer(RabbitTemplate rabbitTemplate,
                         @Value("${gyd.c01.slow-processing-ms:0}") long slowProcessingMs) {
     ...
     *
     * x-death 是数组，每项形如
     * { queue: gyd.c01.order.queue, reason: rejected, count: 2, exchange: ..., routing-keys: [...] }。
