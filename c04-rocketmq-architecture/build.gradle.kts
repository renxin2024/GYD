// c04：RocketMQ 架构与机制。本篇用**裸客户端**而非 rocketmq-spring-boot-starter。
//
...
application {
    // 用法：./gradlew :c04-rocketmq-architecture:run --args="<demo>"
    // demo 取值见 DemoRunner 的帮助输出。
    mainClass = "cn.renxinblog.gyd.c04.DemoRunner"
}
