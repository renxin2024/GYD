...
import cn.renxinblog.gyd.c02.producer.OrderProducer;
...
public class OrderController {
     ...
     * 带 "slow" 则每次处理慢一拍（耗时由 {@code gyd.c02.slow-processing-ms} 控制）。
     */
    @PostMapping
    ...
    public Map<String, Object> probe(@RequestParam String id,
        ...
        return Map.of("sent", true, "id", id, "persistent", persistent,
                "note", "投递到无消费者队列 gyd.c02.persist.probe，重启 broker 后对比消息数");
    }
}
