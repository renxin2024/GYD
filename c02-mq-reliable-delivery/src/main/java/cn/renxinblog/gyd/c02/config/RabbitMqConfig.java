package cn.renxinblog.gyd.c02.config;
...
public class RabbitMqConfig {
    ...
    /** 业务交换机（direct） */
    public static final String ORDER_EXCHANGE = "gyd.c02.order.exchange";
    /** 业务队列 */
    public static final String ORDER_QUEUE = "gyd.c02.order.queue";
    /** 业务路由键 */
    public static final String ORDER_ROUTING_KEY = "order.created";

    /** 重试交换机：业务队列的死信出口 */
    public static final String RETRY_EXCHANGE = "gyd.c02.order.retry.exchange";
    /** 重试队列：消息在此等待 TTL 到期，再被重新投回业务队列 */
    public static final String RETRY_QUEUE = "gyd.c02.order.retry.queue";
    /** 重试路由键 */
    ...
    /** 最终死信交换机 */
    public static final String DEAD_LETTER_EXCHANGE = "gyd.c02.order.dlx";
    /** 最终死信队列 */
    public static final String DEAD_LETTER_QUEUE = "gyd.c02.order.dlq";
    /** 最终死信路由键 */
    public static final String DEAD_LETTER_ROUTING_KEY = "order.dead";

    /** 持久化探针队列：故意不挂消费者，用来观察消息能否挺过 broker 重启 */
    public static final String PERSIST_PROBE_QUEUE = "gyd.c02.persist.probe";
