package cn.renxinblog.gyd.c03.shared.mq;
 ...
 *    反序列化 {@link cn.renxinblog.gyd.c03.shared.clearing.SettlementRecord}，
...
public class MqCommonConfig {
    ...
    public static final String SETTLEMENT_EXCHANGE = "gyd.c03.settlement.exchange";

    /** 付款行队列 */
    public static final String BANK_A_QUEUE = "gyd.c03.settlement.bank-a";
    public static final String BANK_A_ROUTING_KEY = "settlement.bank-a";

    /** 收款行队列 */
    public static final String BANK_B_QUEUE = "gyd.c03.settlement.bank-b";
    ...
    public MessageConverter jsonMessageConverter() {
        ...
        // 信任 c03 下所有会经 MQ 传输的类：消息体是 shared.clearing 里的 SettlementRecord，
